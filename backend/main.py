...
async def handle_request(request: Request):
    try:
        ...
        return JSONResponse(content={
            "fulfillmentText": "It seems some information is missing in your request. Please try again."
        }, status_code=400)
...
def track_order(parameters: dict, session_id: str):
    try:
        ...
        if order_status:
            ...
            response = {
                "fulfillmentText": f"Sorry, I couldn't find any information for order ID {order_id}."
            }
